...
// 여러 가지 기능을 제공할 수 있습니다. argument_type, result_type 등...
...
int main() {
	...
	cout << "30이상 40 이하의 원소 개수: " << count_if(v.begin(), v.end(), Pred) << endl;
	// 가능~!
	cout << "30이상 40 이하가 아닌 원소 개수: " << count_if(v.begin(), v.end(), not1(Ptr_fun(Pred))) << endl;
